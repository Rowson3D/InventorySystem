    ...
    public partial class frmUsers : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sql = "INSERT INTO tbl_Users(users_name, users_username, users_pass, users_type, users_wg, users_zip, users_address, users_phone) VALUES('" + txtName.Text + "', '" + txtUsername.Text + "', '" + txtPassword.Text + "', '" + userType + "', 0, '" + txtZip.Text + "' , '" + txtAddress.Text + "', '" + txtPhone.Text + "')";
        ...
        {
        config.Load_DTG("SELECT users_id as 'ID' , users_name as 'Name', users_username as 'Username', users_pass as 'Password', users_address as 'Address', users_zip as 'Zip Code', users_phone as 'Phone' ,users_type as 'Type' from tbl_Users", dtg_listUser);
        }
        ...
        private void dtg_listUser_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                txtZip.Text = row.Cells[5].Value.ToString();
                ...
                if (row.Cells[7].Value.ToString() == "3")
                {
                    cboType.SelectedIndex = 3;
                }
                else if (row.Cells[7].Value.ToString() == "2")
                {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sql = "UPDATE tbl_Users SET users_name = '" + txtName.Text + "', users_username = '" + txtUsername.Text + "', users_pass = '" + txtPassword.Text + "', users_type = '" + userType + "', users_zip = '" + txtZip.Text + "',users_address = '" + txtAddress.Text + "' WHERE users_id = '" + id +"'";
